...
name='Jabber'
read -p "channel namespace ($name): " channel_namespace
channel_namespace=${channel_namespace:-$name}
read -p "service name ($name): " service_name
service_name=${service_name:-$name}

read -p "author website ($name): " author_website
